...
const MintedCrowdsale = artifacts.require('CombisCrowdsale');
const MintableToken = artifacts.require('CombisToken');
const RBACMintableToken = artifacts.require('MintableToken');
...
contract('MintedCrowdsale', function ([_, investor, wallet, purchaser]) {
  ...
  describe('using MintableToken', function () {
    beforeEach(async function () {
      ...
      this.crowdsale = await MintedCrowdsale.new(wallet, this.token.address);
